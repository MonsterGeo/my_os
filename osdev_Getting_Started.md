...
无需寻找特定发行版本，如果你想知道具体有什么，可以查看Linux发行表，这些系统具有各种形状和大小，只要是相对通用的就可以使用了，如果你不知道什么操作系统对你友好，那么你可以试试Ubuntu、Fedora或Linux Mint.

## Windows
为了获取必要的工具，您应安装Cygwin环境。MinGW或DJGPP是替代方案，但强烈建议使用MSYS2，因为它是最完整且兼容性最高的环境，并且还包含一个包管理器，用于安装库和工具。
